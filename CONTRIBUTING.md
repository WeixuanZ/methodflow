...
Welcome to `methodflow` contributor's guide.
...
If you experience bugs or general issues with `methodflow`, please have a look
...
You can help improve `methodflow` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`methodflow` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `methodflow`'s files. While this mechanism can
...
```
conda create -n methodflow python=3 six virtualenv pytest pytest-cov
conda activate methodflow
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/methodflow.git
   cd methodflow
   ```
...
5. Install [pre-commit]:
   ...
   `methodflow` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/methodflow
[issue tracker]: https://github.com/<USERNAME>/methodflow/issues
